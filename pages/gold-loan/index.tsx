    ...
    <Layout title="Gold Loans">
      ...
      <div className="page-row gl-content mobile-not-reversed">
        <div className="gl-content-text">
          <h1 className="mb-32">Why get your gold loan from us?</h1>
          <div className="li-div">
            <img src={CheckIcon} alt="check-icon"/>
            <p>Highest value for your gold.</p></div>
          <div className="li-div">
            <img src={CheckIcon} alt="check-icon"/>
            <p>Lowest interest rates in the market.</p></div>
          <div className="li-div">
            <img src={CheckIcon} alt="check-icon"/>
            <p>Get money in your account in less than 1 hour.</p></div>
        </div>
