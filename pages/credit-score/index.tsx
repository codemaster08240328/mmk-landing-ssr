    ...
    <Layout title="Credit Score">
      ...
      <div className="page-row cs-content mobile-not-reversed">
        <div className="cs-content-text">
          <h1 className="mb-32">Why us?</h1>
          <div className="li-div">
            <img src={CheckIcon} alt="check-icon"/>
            <p>Free credit score analysis.</p></div>
          <div className="desktop li-div">
            <img src={CheckIcon} alt="check-icon"/>
            <p>Simplified credit report to help you understand <br /> your score.</p></div>
          <div className="desktop li-div">
            <img src={CheckIcon} alt="check-icon"/>
            <p>Personalized credit score insights to help you <br /> improve your score.</p></div>
          <div className="mobile"><p>Simplified credit report to help you understand your score.</p></div>
          <div className="mobile"><p>Personalized credit score insights to help you improve your score.</p></div>
        </div>
