    ...
    <Layout title="Home Loans">
      ...
      <div className="page-row hl-content mobile-not-reversed">
        <div className="hl-content-text">
          <h1 className="mb-32">Why get your home loan from us?</h1>
          <div className="desktop li-div">
            <img src={CheckIcon} alt="check-icon"/>
            <p>Save time by evaluating offers from many of <br /> the top providers in the market in one place.</p></div>
          <div className="mobile"><p>Save time by evaluating offers from many of the top providers in the market in one place.</p></div>
          <div className="desktop li-div">
            <img src={CheckIcon} alt="check-icon"/>
            <p>Get matched with the cheapest home loan offer <br /> in the market.</p></div>
          <div className="mobile"><p>Get matched with the cheapest home loan offer in the market.</p></div>
          <div className="li-div">
            <img src={CheckIcon} alt="check-icon"/>
            <p>Get expedited approvals.</p></div>
        </div>
